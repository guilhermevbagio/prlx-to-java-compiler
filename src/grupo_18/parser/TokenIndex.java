...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTSimbolo(@SuppressWarnings("unused") TSimbolo node)
    {
        this.index = 4;
    }

    @Override
    public void caseTValorBooleano(@SuppressWarnings("unused") TValorBooleano node)
    {
        this.index = 5;
    }

    @Override
    public void caseTVectorMatrix(@SuppressWarnings("unused") TVectorMatrix node)
    {
        this.index = 6;
    }
    ...
    @Override
    public void caseTThatKw(@SuppressWarnings("unused") TThatKw node)
    {
        this.index = 32;
    }
    ...
    @Override
    public void caseTSymbolValue(@SuppressWarnings("unused") TSymbolValue node)
    {
        this.index = 69;
    }
