...
public final class AComandoShowComando extends PComando
{
    ...
    public Object clone()
    {
        return new AComandoShowComando(
    ...
    {
        ((Analysis) sw).caseAComandoShowComando(this);
    }
