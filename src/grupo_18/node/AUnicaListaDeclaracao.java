...
public final class AUnicaListaDeclaracao extends PListaDeclaracao
{
    private PDeclaracao _declaracao_;

    public AUnicaListaDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnicaListaDeclaracao(
    ...
    {
        ((Analysis) sw).caseAUnicaListaDeclaracao(this);
    }
