...
public final class AAndExpRTermAndExpRparen extends PAndExpRparen
{
    private PRelExp _relExp_;

    public AAndExpRTermAndExpRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndExpRTermAndExpRparen(
    ...
    {
        ((Analysis) sw).caseAAndExpRTermAndExpRparen(this);
    }
