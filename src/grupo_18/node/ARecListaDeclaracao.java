...
public final class ARecListaDeclaracao extends PListaDeclaracao
{
    private PListaDeclaracao _listaDeclaracao_;
    private PDeclaracao _declaracao_;

    public ARecListaDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ARecListaDeclaracao(
    ...
    {
        ((Analysis) sw).caseARecListaDeclaracao(this);
    }
