...
public final class AProgramaAlt4Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AProgramaAlt4Programa(
    ...
    {
        ((Analysis) sw).caseAProgramaAlt4Programa(this);
    }
