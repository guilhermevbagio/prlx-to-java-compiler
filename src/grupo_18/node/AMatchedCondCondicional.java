...
public final class AMatchedCondCondicional extends PCondicional
{
    private PMatched _matched_;

    public AMatchedCondCondicional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMatchedCondCondicional(
    ...
    {
        ((Analysis) sw).caseAMatchedCondCondicional(this);
    }
