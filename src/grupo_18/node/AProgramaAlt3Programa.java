...
public final class AProgramaAlt3Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AProgramaAlt3Programa(
    ...
    {
        ((Analysis) sw).caseAProgramaAlt3Programa(this);
    }
