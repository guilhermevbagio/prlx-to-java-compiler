...
public final class AComandoContinueComandoSemIf extends PComandoSemIf
{
    private TGo _go_;
    private TTo _to_;
    ...
    public AComandoContinueComandoSemIf()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoContinueComandoSemIf(
            cloneNode(this._go_),
            cloneNode(this._to_),
    ...
    {
        ((Analysis) sw).caseAComandoContinueComandoSemIf(this);
    }
