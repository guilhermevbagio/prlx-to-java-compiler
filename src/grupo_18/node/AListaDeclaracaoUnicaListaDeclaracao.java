...
public final class AListaDeclaracaoUnicaListaDeclaracao extends PListaDeclaracao
{
    private PDeclaracao _declaracao_;

    public AListaDeclaracaoUnicaListaDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListaDeclaracaoUnicaListaDeclaracao(
    ...
    {
        ((Analysis) sw).caseAListaDeclaracaoUnicaListaDeclaracao(this);
    }
