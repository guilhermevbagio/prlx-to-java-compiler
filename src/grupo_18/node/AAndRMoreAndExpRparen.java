...
public final class AAndRMoreAndExpRparen extends PAndExpRparen
{
    private PRelExp _relExp_;
    private TAnd _and_;
    private PAndExpRparen _andExpRparen_;

    public AAndRMoreAndExpRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndRMoreAndExpRparen(
    ...
    {
        ((Analysis) sw).caseAAndRMoreAndExpRparen(this);
    }
