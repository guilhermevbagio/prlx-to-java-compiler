...
public final class AListaExpMoreListaExpRparen extends PListaExpRparen
{
    private PExp _exp_;
    private TVirgula _virgula_;
    private PListaExpRparen _listaExpRparen_;

    public AListaExpMoreListaExpRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListaExpMoreListaExpRparen(
    ...
    {
        ((Analysis) sw).caseAListaExpMoreListaExpRparen(this);
    }
