...
public final class ACmdContinueComando extends PComando
{
    private TGo _go_;
    private TTo _to_;
    ...
    public Object clone()
    {
        return new ACmdContinueComando(
            cloneNode(this._go_),
            cloneNode(this._to_),
    ...
    {
        ((Analysis) sw).caseACmdContinueComando(this);
    }
