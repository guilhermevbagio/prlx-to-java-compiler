...
public final class AComandoIfelseComando extends PComando
{
    private PIfThen _ifThen_;
    private PElseTail _elseTail_;

    public AComandoIfelseComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoIfelseComando(
    ...
    {
        ((Analysis) sw).caseAComandoIfelseComando(this);
    }
