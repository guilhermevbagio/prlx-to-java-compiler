...
public final class AProgramaAlt2Programa extends PPrograma
{
    ...
    public Object clone()
    {
        return new AProgramaAlt2Programa(
    ...
    {
        ((Analysis) sw).caseAProgramaAlt2Programa(this);
    }
