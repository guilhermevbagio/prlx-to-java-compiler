...
public final class AOrRMoreOrTailRparen extends POrTailRparen
{
    private TOr _or_;
    private PAndExpRparen _andExpRparen_;
    private POrTailRparen _orTailRparen_;

    public AOrRMoreOrTailRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOrRMoreOrTailRparen(
            cloneNode(this._or_),
    ...
    {
        ((Analysis) sw).caseAOrRMoreOrTailRparen(this);
    }
