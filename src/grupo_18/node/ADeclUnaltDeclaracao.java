...
public final class ADeclUnaltDeclaracao extends PDeclaracao
{
    ...
    public Object clone()
    {
        return new ADeclUnaltDeclaracao(
    ...
    {
        ((Analysis) sw).caseADeclUnaltDeclaracao(this);
    }
