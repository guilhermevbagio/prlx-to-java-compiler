...
public final class AMultDimensaoVetor extends PDimensaoVetor
{
    private PDimensaoVetor _dimensaoVetor_;
    private TVezes _vezes_;
    private PExp _exp_;

    public AMultDimensaoVetor()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAMultDimensaoVetor(this);
    }
