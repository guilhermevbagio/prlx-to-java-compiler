...
public final class AAndRTermAndExpRparen extends PAndExpRparen
{
    private PRelExp _relExp_;

    public AAndRTermAndExpRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndRTermAndExpRparen(
    ...
    {
        ((Analysis) sw).caseAAndRTermAndExpRparen(this);
    }
