...
public final class AComandoContinueComando extends PComando
{
    private TGo _go_;
    private TTo _to_;
    ...
    public AComandoContinueComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoContinueComando(
            cloneNode(this._go_),
            cloneNode(this._to_),
    ...
    {
        ((Analysis) sw).caseAComandoContinueComando(this);
    }
