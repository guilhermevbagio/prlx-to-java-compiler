...
public final class AAndRComAndTailRparen extends PAndTailRparen
{
    private TVirgula _virgula_;
    private PListaExpRparen _listaExpRparen_;

    public AAndRComAndTailRparen()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAndRComAndTailRparen(
    ...
    {
        ((Analysis) sw).caseAAndRComAndTailRparen(this);
    }
