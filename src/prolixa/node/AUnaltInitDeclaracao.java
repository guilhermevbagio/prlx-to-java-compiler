...
public final class AUnaltInitDeclaracao extends PDeclaracao
{
    private PTipo _tipo_;
    private TIdentificador _identificador_;
    private PValor _valor_;

    public AUnaltInitDeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AUnaltInitDeclaracao(
    ...
    {
        ((Analysis) sw).caseAUnaltInitDeclaracao(this);
    }
