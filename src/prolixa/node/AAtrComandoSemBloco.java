...
public final class AAtrComandoSemBloco extends PComandoSemBloco
{
    private PVar _var_;
    ...
    public Object clone()
    {
        return new AAtrComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseAAtrComandoSemBloco(this);
    }
