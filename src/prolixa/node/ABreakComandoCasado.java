...
public final class ABreakComandoCasado extends PComandoCasado
{
    private TAbandon _abandon_;
    private TPontoEVirgula _pontoEVirgula_;

    public ABreakComandoCasado()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABreakComandoCasado(
    ...
    {
        ((Analysis) sw).caseABreakComandoCasado(this);
    }
