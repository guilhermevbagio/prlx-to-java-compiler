...
public final class ACapComandoSemBloco extends PComandoSemBloco
{
    ...
    public Object clone()
    {
        return new ACapComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseACapComandoSemBloco(this);
    }
