...
public final class AJustCmdElseJustStmt extends PJustStmt
{
    ...
    public Object clone()
    {
        return new AJustCmdElseJustStmt(
    ...
    {
        ((Analysis) sw).caseAJustCmdElseJustStmt(this);
    }
