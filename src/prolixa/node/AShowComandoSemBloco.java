...
public final class AShowComandoSemBloco extends PComandoSemBloco
{
    ...
    public Object clone()
    {
        return new AShowComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseAShowComandoSemBloco(this);
    }
