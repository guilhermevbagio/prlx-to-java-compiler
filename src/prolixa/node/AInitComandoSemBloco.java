...
public final class AInitComandoSemBloco extends PComandoSemBloco
{
    ...
    public Object clone()
    {
        return new AInitComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseAInitComandoSemBloco(this);
    }
