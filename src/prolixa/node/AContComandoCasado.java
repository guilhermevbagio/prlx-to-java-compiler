...
public final class AContComandoCasado extends PComandoCasado
{
    private TGo _go_;
    private TTo _to_;
    ...
    {
        ((Analysis) sw).caseAContComandoCasado(this);
    }
