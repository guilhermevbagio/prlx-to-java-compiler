...
public final class ACmdBlkComandoCasado extends PComandoCasado
{
    private PBloco _bloco_;

    public ACmdBlkComandoCasado()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmdBlkComandoCasado(
    ...
    {
        ((Analysis) sw).caseACmdBlkComandoCasado(this);
    }
