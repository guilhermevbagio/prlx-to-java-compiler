...
public final class AComandoBreakComando extends PComando
{
    private TAbandon _abandon_;
    private TPontoEVirgula _pontoEVirgula_;

    public AComandoBreakComando()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoBreakComando(
    ...
    {
        ((Analysis) sw).caseAComandoBreakComando(this);
    }
