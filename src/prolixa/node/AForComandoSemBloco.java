...
public final class AForComandoSemBloco extends PComandoSemBloco
{
    private PForStmt _forStmt_;

    public AForComandoSemBloco()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AForComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseAForComandoSemBloco(this);
    }
