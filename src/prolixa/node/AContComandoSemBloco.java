...
public final class AContComandoSemBloco extends PComandoSemBloco
{
    private TGo _go_;
    private TTo _to_;
    ...
    public Object clone()
    {
        return new AContComandoSemBloco(
            cloneNode(this._go_),
            cloneNode(this._to_),
    ...
    {
        ((Analysis) sw).caseAContComandoSemBloco(this);
    }
