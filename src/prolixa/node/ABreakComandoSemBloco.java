...
public final class ABreakComandoSemBloco extends PComandoSemBloco
{
    private TAbandon _abandon_;
    private TPontoEVirgula _pontoEVirgula_;

    public ABreakComandoSemBloco()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABreakComandoSemBloco(
    ...
    {
        ((Analysis) sw).caseABreakComandoSemBloco(this);
    }
