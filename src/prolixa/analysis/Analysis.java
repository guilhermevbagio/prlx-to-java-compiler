...
public interface Analysis extends Switch
{
    ...
    void caseAAtrComandoSemBloco(AAtrComandoSemBloco node);
    void caseAInitComandoSemBloco(AInitComandoSemBloco node);
    void caseACapComandoSemBloco(ACapComandoSemBloco node);
    void caseAShowComandoSemBloco(AShowComandoSemBloco node);
    void caseAWhileComandoSemBloco(AWhileComandoSemBloco node);
    void caseAForComandoSemBloco(AForComandoSemBloco node);
    void caseABreakComandoSemBloco(ABreakComandoSemBloco node);
    void caseAContComandoSemBloco(AContComandoSemBloco node);
    void caseAIfHeadKwIfHead(AIfHeadKwIfHead node);
    void caseAIfBlkIfBlk(AIfBlkIfBlk node);
    void caseAIfElseIfTailBlk(AIfElseIfTailBlk node);
    void caseAIfEndIfTailBlk(AIfEndIfTailBlk node);
    void caseAIfCmdIfCmd(AIfCmdIfCmd node);
    void caseACmdBlocoComando(ACmdBlocoComando node);
    void caseACmdIfblkComando(ACmdIfblkComando node);
    void caseACmdIfcmdComando(ACmdIfcmdComando node);
    void caseACmdCoreComando(ACmdCoreComando node);
    void caseAJustCondJustStmt(AJustCondJustStmt node);
    void caseAJustCondElseJustStmt(AJustCondElseJustStmt node);
    void caseAElseStms(AElseStms node);
    ...
    void caseABlocoDecBloco(ABlocoDecBloco node);
