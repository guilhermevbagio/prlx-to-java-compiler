...
public interface Analysis extends Switch
{
    ...
    void caseACmdCndComando(ACmdCndComando node);
    void caseACmdSoltComando(ACmdSoltComando node);
    void caseAAtrComandoCasado(AAtrComandoCasado node);
    void caseAInitComandoCasado(AInitComandoCasado node);
    void caseAIfCasaComandoCasado(AIfCasaComandoCasado node);
    void caseACapComandoCasado(ACapComandoCasado node);
    void caseAShowComandoCasado(AShowComandoCasado node);
    void caseAWhileComandoCasado(AWhileComandoCasado node);
    void caseAForComandoCasado(AForComandoCasado node);
    void caseABreakComandoCasado(ABreakComandoCasado node);
    void caseAContComandoCasado(AContComandoCasado node);
    void caseACmdBlkComandoCasado(ACmdBlkComandoCasado node);
    void caseAIfSCmComandoSolteiro(AIfSCmComandoSolteiro node);
    void caseAIfSMixComandoSolteiro(AIfSMixComandoSolteiro node);
